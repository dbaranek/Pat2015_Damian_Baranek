...
public class SplashScreen extends ActionBarActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //pobieranie danych o logowaniu
        SharedPreferences loginInformation = PreferenceManager.getDefaultSharedPreferences(SplashScreen.this);
        boolean isLogIn = loginInformation.getBoolean("isLogIn",false);
        if(isLogIn) {
